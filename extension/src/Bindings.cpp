...
static const BuiltinDoc kBuiltinDocs[] = {
    ...
    { "recv_this",
      ...
      "faders, 1 on the V-Pots. Nothing on a one-strip surface." },
    { "uf8_led_probe_step",
      "Lights the next UF8 LED cell nobody has mapped, one per press, and "
      "names it in REAPER's console. For finding out whether a button has "
      "an LED behind it at all." },
