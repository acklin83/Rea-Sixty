...
private:
    ...
    // Was zuletzt im Model-Feld stand (das Feld ueber dem Spurnamen, in dem
    // sonst "CS 2" steht). poll() vergleicht den Eingangsnamen damit, weil ein
    // Eingangswechsel sonst kein refresh() ausloest (UC1Surface.cpp, REC + RME).
    std::string lastCentralLabel_;
