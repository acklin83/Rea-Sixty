...
local CTRLS = {
  ...
  {  1, 0, "c", "HPF",        "Filter",        162, 70,  20, 0,  0,  GY, "HPF"  },
  {  2, 1, "c", "HF Type",    "EQ",            145, 140, 0,  34, 18, NC, "BELL" },
  {  3, 0, "c", "HF Gain",    "EQ",            82,  160, 20, 0,  0,  R,  "GAIN" },
  {  4, 0, "c", "HF Freq",    "EQ",            162, 188, 20, 0,  0,  R,  "FREQ" },
  {  5, 0, "c", "HMF Gain",   "EQ",            82,  260, 20, 0,  0,  G,  "GAIN" },
  {  6, 0, "c", "HMF Freq",   "EQ",            162, 288, 20, 0,  0,  G,  "FREQ" },
  {  7, 0, "c", "HMF Q",      "EQ",            82,  328, 20, 0,  0,  G,  "Q"    },
  {  8, 1, "c", "EQ Type",    "EQ",            183, 370, 0,  34, 18, NC, "TYPE" },
  {  9, 1, "c", "EQ In",      "EQ",            145, 370, 0,  34, 18, NC, "EQ"   },
  { 10, 0, "c", "LMF Gain",   "EQ",            82,  430, 20, 0,  0,  B,  "GAIN" },
  { 11, 0, "c", "LMF Freq",   "EQ",            162, 458, 20, 0,  0,  B,  "FREQ" },
  { 12, 0, "c", "LMF Q",      "EQ",            82,  498, 20, 0,  0,  B,  "Q"    },
  { 13, 0, "c", "LF Freq",    "EQ",            162, 558, 20, 0,  0,  K,  "FREQ" },
  { 14, 0, "c", "LF Gain",    "EQ",            82,  598, 20, 0,  0,  K,  "GAIN" },
  { 15, 1, "c", "LF Type",    "EQ",            145, 620, 0,  34, 18, NC, "BELL" },
  ...
  { 23, 1, "b", "Bypass",     "Bus Comp",      470, 288, 0,  40, 40, NC, "IN"   },
  ...
  { 28, 0, "c", "Comp Ratio", "Dynamics",      678, 100, 20, 0,  0,  GY, "RATIO"},
  { 29, 0, "c", "Comp Thr",   "Dynamics",      774, 128, 20, 0,  0,  GY, "THR"  },
  { 30, 0, "c", "Comp Rel",   "Dynamics",      678, 168, 20, 0,  0,  GY, "REL"  },
  { 31, 1, "c", "Dynamics In","Dynamics",      661, 235, 0,  34, 22, NC, "DYN"  },
  { 32, 0, "c", "Gate Range", "Gate",          678, 324, 20, 0,  0,  GY, "RNG"  },
  { 33, 0, "c", "Gate Thr",   "Gate",          774, 352, 20, 0,  0,  GY, "THR"  },
  { 34, 0, "c", "Gate Rel",   "Gate",          678, 392, 20, 0,  0,  GY, "REL"  },
  { 35, 0, "c", "Gate Hold",  "Gate",          774, 420, 20, 0,  0,  GY, "HOLD" },
  { 36, 2, "c", "Gate/Exp",   "Gate",          645, 462, 0,  66, 22, NC, "G/E"  },
  { 37, 2, "c", "Gate F.Atk", "Gate",          645, 488, 0,  66, 22, NC, "F.ATK"},
  { 38, 2, "c", "Polarity",   "I/O & Channel", 632, 540, 0,  96, 26, NC, "POL"  },
  { 39, 2, "c", "S/C Listen", "I/O & Channel", 632, 574, 0,  96, 26, NC, "LST"  },
  { 40, 1, "c", "Bypass",     "I/O & Channel", 776, 547, 0,  40, 40, NC, "IN"   },
}
